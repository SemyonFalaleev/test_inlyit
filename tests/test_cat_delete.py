...
@pytest.mark.asyncio
async def test_delete_category_success_as_admin(
...
@pytest.mark.asyncio
async def test_delete_category_as_regular_user(
    async_client: AsyncClient,
    db_session,
):
    try:
...
async def test_delete_category_unauthorized(
    ...
    try:
        ...
        response = await async_client.delete(f"/category/{test_category.id}")
...
async def test_delete_category_not_found(
    ...
    try:
        ...
        response = await async_client.delete("/category/999", headers=headers)
